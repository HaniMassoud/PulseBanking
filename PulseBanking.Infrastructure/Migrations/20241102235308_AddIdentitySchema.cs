        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RunningBalanceAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    RunningBalanceCurrency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransactionHistory_Accounts_CounterpartyAccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionHistory_CounterpartyAccountId",
                table: "TransactionHistory",
                column: "CounterpartyAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_TransactionHistory_ProcessedDate",
                table: "TransactionHistory",
                column: "ProcessedDate");

            migrationBuilder.CreateIndex(
                name: "IX_TransactionHistory_TenantId",
                table: "TransactionHistory",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_TransactionHistory_TenantId_AccountId_ProcessedDate",
                table: "TransactionHistory",
                columns: new[] { "TenantId", "AccountId", "ProcessedDate" });

            migrationBuilder.CreateIndex(
                name: "IX_TransactionHistory_TenantId_ExternalReference",
                table: "TransactionHistory",
                columns: new[] { "TenantId", "ExternalReference" },
                filter: "[ExternalReference] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_TransactionHistory_TenantId_Reference",
                table: "TransactionHistory",
                columns: new[] { "TenantId", "Reference" });

            migrationBuilder.CreateIndex(
                name: "IX_TransactionHistory_TenantId_Type",
                table: "TransactionHistory",
                columns: new[] { "TenantId", "Type" });

            migrationBuilder.CreateIndex(
                name: "IX_TransactionHistory_TenantId_ValueDate",
                table: "TransactionHistory",
                columns: new[] { "TenantId", "ValueDate" });

            migrationBuilder.CreateIndex(
                name: "IX_UserClaims_TenantId",
                table: "UserClaims",
                column: "TenantId");
